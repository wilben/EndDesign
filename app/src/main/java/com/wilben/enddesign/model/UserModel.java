package com.wilben.enddesign.model;
...
import com.wilben.enddesign.model.i.QueryUserListener;
...
public class UserModel extends BaseModel {
    ...
    public void login(String username, String password, final LogInListener listener) {
        ...
        final Bomb_User user = new Bomb_User();
    ...
    public Bomb_User getCurrentUser() {
        return BmobUser.getCurrentUser(getContext(), Bomb_User.class);
    }
     ...
     * @param listener
     */
    public void queryUsers(String username, int limit, final FindListener<Bomb_User> listener) {
        BmobQuery<Bomb_User> query = new BmobQuery<>();
        //去掉当前用户
        try {
        ...
        query.findObjects(getContext(), new FindListener<Bomb_User>() {
            @Override
    ...
    public void updateUserInfo(MessageEvent event, final UpdateCacheListener listener) {
        ...
        if (!username.equals(title)) {
            UserModel.getInstance().queryUserInfo(info.getUserId(), new QueryUserListener() {
                @Override
                public void done(Bomb_User s, BmobException e) {
                    if (e == null) {
